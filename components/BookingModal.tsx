      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
        <div className="bg-white rounded-3xl p-8 w-full max-w-md text-center shadow-2xl transform scale-100 transition-all">
          ...
          <button 
            ...
            className="w-full bg-slate-900 text-white py-3 rounded-xl font-medium hover:bg-sky-600 transition-colors"
          >
            Отлично
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 sm:p-8 space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                type="date" 
                required
                className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 outline-none transition-all text-slate-600"
                value={formData.date}
          ...
          <div className="pt-4">
            <button 
              type="submit"
              className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold py-4 rounded-xl shadow-lg shadow-sky-600/20 transition-all transform hover:-translate-y-0.5 active:scale-95"
            >
              Отправить заявку
            </button>
